		...
		<section class="box">
			...
			<div class="mb_lg p_xs2 shadow_md border_radius_sm">
				<div class="width_atmost_sm panel p_lg shadow_inset_xs shade_00">
					...
					<p>
						Fuz has no shareholders or profit motive, and the intent is to form a nonprofit; but
						it's a road to get there, and a community would have to form first. This website will
